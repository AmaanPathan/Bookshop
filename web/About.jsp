...
<!-- End css3menu.com BODY section -->
    ...
    <div id="middle">
		...
		<p>This is a  project with the objective to develop a basic website where a consumer is  provided with a shopping cart application and also to know about the  technologies used to develop such an application.This document will discuss  each of the underlying technologies to create and implement an ebook  store. In order to develop an e-commerce  website, a number of Technologies must be studied and understood. These include  multi-tiered architecture, server and client side scripting  techniques,implementation technologies such as JSP, programming language (such  as JAVA, JavaScript,and HTML), relational databases (such as MySQL,<br />
	    Access).</p>
<!-- InstanceEndEditable -->        
        </div><!-- end of content -->
        <div id="ad">
